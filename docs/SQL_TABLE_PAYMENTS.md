...
-- ⚠️ IMPORTANT : La fonction is_user_admin() doit exister (créée dans SQL_TABLE_MESSAGES.md)
...
2. **Admins** : Peuvent voir tous les paiements via les politiques RLS
